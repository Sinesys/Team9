...
<body>
            ...
            <div class="container-fluid p-5">
                ...
                <div class="card mx-auto">
                    <div class="card-header d-flex justify-content-between">
                        <span class="h2">Sites</span>
                        <button type="button" name="add-site" id="insert-site" class="btn btn-primary" data-toggle="modal" data-target="#sites-modal">
                    ...
                    <div class="card-body bg-light p-5">
                        ...
                        <div class="table-responsive-xl">
                            <table class="table table-bordered" id="sites-table-master">
                                <thead>
                                    <tr>
                                        <th></th>
    ...
    <?php include_once 'sites_management_modal.html' ?>     

    <template id="site-information-row">
        <tr>
            <td style="vertical-align: middle; white-space: nowrap; width: 1%;">
                <button type="button" name="{id}" id="modify-{id}" class="btn btn-primary mr-3" data-toggle="modal" data-target="#sites-modal">
                    <i class="far fa-edit"></i>
                </button>
            </td>
            <td style="text-align:center; vertical-align: middle;">{id}</td> 
            <td style="text-align:center; vertical-align: middle;">{area}</td>
            <td style="text-align:center; vertical-align: middle;">{department}</td>                                          
            <td style="vertical-align: middle; white-space: nowrap;width: 1%;">
                <button type="button" class="btn btn-danger" onclick="siteDelete('{id}')">
    ...
    <script type="text/javascript" src="static/js/sites_list.js"></script>
